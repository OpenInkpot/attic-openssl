...
OPTIONS=--prefix=/usr --openssldir=/usr/lib/ssl enable-zlib no-asm no-gmp no-idea no-krb5 no-mdc2 no-rc5 no-shared no-zlib-dynamic
CONFIGURE_ARGS=--prefix=/usr --openssldir=/usr/lib/ssl no-idea no-mdc2 no-rc5 zlib no-asm debian-i386
